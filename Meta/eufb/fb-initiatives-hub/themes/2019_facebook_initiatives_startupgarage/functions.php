...
/**
 *  Add Admin Custom Script
 *
 */
function admin_script_admin_enqueue() {
	$screen = get_current_screen();
	// load on the NEW and EDIT screens of all post types
	if ( 'post' === $screen->base ) {
		wp_enqueue_script('CMS-Custom-Javascript', get_template_directory_uri() . '/assets/js/cms-custom.js');
	}
}
add_action('admin_enqueue_scripts', 'admin_script_admin_enqueue');
...
// Remove main WYSIWYG editor from CMS
function remove_editor() {
  remove_post_type_support('page', 'editor');
}
add_action('admin_init', 'remove_editor');
// Remove Posts from CMS
